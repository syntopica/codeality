"""Plan every edit codeality-py makes to pyproject.toml, as one file."""

from pathlib import Path

from codeality_py.init.has_ruff_table import has_ruff_table
from codeality_py.init.managed_file import ManagedFile
from codeality_py.init.merge_pyproject_sections import merge_pyproject_sections
from codeality_py.init.merge_ruff_config import merge_ruff_config
