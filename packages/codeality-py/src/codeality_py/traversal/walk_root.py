...
from codeality_py.traversal.default_excludes import DEFAULT_EXCLUDES
from codeality_py.traversal.gitignore_matcher import GitignoreMatcher

SOURCE_SUFFIXES = (".py", ".pyi")


def walk_root(start: Path, project_root: Path, matcher: GitignoreMatcher | None) -> list[Path]:
