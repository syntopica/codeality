...
from codeality_py.config.check_schema_version import (
...
from codeality_py.config.read_config_document import read_config_document
from codeality_py.config.reject_unknown_keys import reject_unknown_keys

CONFIG_FILENAME = "codeality-py.toml"
